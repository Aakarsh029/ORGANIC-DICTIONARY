...
void cover() //Name of Project
{
		...
		for(int n=0;n<122;n++)
	{
		...
		cout<<endl;
	cout<<"\n\n\n\n\n\n\n\t\t\tCopyrights 2019, Organic Tech Dictionary, All Rights Reserved.";
	for(int n=0;n<28;n++)
	{
		cout<<".";
...
{	
	...
	file.close();
	     cout<<"\n\n__________________________________________________________________________________________________________________________";
		 cout<<"\t\t\t\tCopyrights 2019, Organic Tech Dictionary, All Rights Reserved\t  Press ENTER to continue";
...
{"prot�g�","n. One specially cared for and favored by another usually older person."},
...
{"s�ance","n.A meeting of spirituals for consulting spirits."},
